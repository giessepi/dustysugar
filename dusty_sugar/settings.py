...
SECRET_KEY = 'django-insecure-v4krgackk_ubajvqj*=l^3v5i#ci)0phe!gtssns7+@e&yu8d('

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['dustysugar.tn', '127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Indiquez le dossier templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dusty_sugar',
        'USER': 'postgres',
        'PASSWORD': 'admin',  # Remplace 'password' par le mot de passe réel
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Le dossier où collectstatic va copier les fichiers

# Media files (Uploaded files)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Chemin où seront sauvegardés les fichiers téléchargés par les utilisateurs
